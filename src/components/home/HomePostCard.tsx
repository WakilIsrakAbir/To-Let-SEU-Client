...
export default function HomePostCard({ post }: HomePostCardProps) {
  ...
  return (
    <motion.article
      ...
      className="bg-white dark:bg-slate-900/90 rounded-3xl border border-slate-200/90 dark:border-slate-800 shadow-sm hover:shadow-md transition-all overflow-hidden p-4 sm:p-5 space-y-3 scroll-mt-28 flex flex-col justify-between"
    >
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <span
                className={`px-2 py-0.5 rounded-lg text-[10px] font-black uppercase tracking-wider shrink-0 border ${
                  post.gender === 'Male'
            ...
            {/* Bottom Line: Dept & Relative Time */}
        ...
        {/* 2. Specs: 2 Distinct Lines on Homepage Card */}
        {/* Line 1: Seat / Room full name + Availability Date */}
        ...
        <AnimatePresence>
          {showDetails && (
            ...
            >
              ...
              {post.addressDetails && (
                <div className="p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/80 dark:border-slate-700/60 text-xs text-slate-700 dark:text-slate-300 flex items-start gap-2">
        ...
        <div className="px-3.5 py-2.5 rounded-xl bg-gradient-to-r from-emerald-500/10 via-teal-500/5 to-slate-50 dark:from-emerald-950/35 dark:via-slate-800/60 dark:to-slate-900 border border-emerald-500/20 dark:border-emerald-500/20 shadow-xs">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="shrink-0">
              <span
                className={`px-2 py-0.5 rounded-md text-[11px] font-bold border flex items-center gap-1 shadow-2xs whitespace-nowrap ${
      ...
      {/* 5. Action Triggers Bar (Call, WhatsApp, Share) in 1 single row */}
      <div className="pt-2 border-t border-slate-100 dark:border-slate-800">
        <div className="flex items-center gap-1.5">
          ...
          <a
            ...
            className="flex-1 min-w-0 h-9 sm:h-10 px-2 text-white border-none rounded-xl text-xs font-bold flex items-center justify-center gap-1 shadow-xs hover:opacity-90 transition whitespace-nowrap"
          ...
          <a
            ...
            className="shrink-0 h-9 sm:h-10 px-2 sm:px-2.5 border rounded-xl text-xs font-bold flex items-center justify-center gap-1 hover:opacity-90 transition whitespace-nowrap"
          ...
          <button
            onClick={handleShare}
            className="shrink-0 h-9 sm:h-10 px-2 sm:px-2.5 flex items-center justify-center gap-1 rounded-xl text-xs font-bold text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-2xs transition whitespace-nowrap"
