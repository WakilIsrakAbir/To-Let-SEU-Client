...
export default function SettingsDrawer() {
  ...
  return (
    <>
      {/* Floating Gear Button (Adapts to Active Theme Accent Color; anchored to the middle right edge like big displays) */}
      <div className="fixed right-0 top-1/2 -translate-y-1/2 z-[9990] pointer-events-auto">
        <button
          ...
          className="group relative flex items-center justify-center w-11 h-11 sm:w-12 sm:h-12 active:scale-95 text-white rounded-l-2xl rounded-r-none shadow-2xl transition-all duration-300 cursor-pointer border border-white/25 border-r-0 select-none hover:opacity-95"
